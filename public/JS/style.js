class Style{
  constructor(){
    ...
    this.childcetusTimer = this.cetusTimer.querySelector('#cetustimer > span');
    //baro
    this.barooTimer = document.querySelector('#timerBaro');
    this.childbarooTimer = this.barooTimer.querySelector('#timerBaro > span');
    //fissures
    this.fissuresTimer = document.querySelector('div#fissures');
    this.childfissuresTimer = this.fissuresTimer.querySelector('div#fissures > span');
    //figures
