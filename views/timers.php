...
<div id="fissures">
    ...
    if(count($arrayT1) != 0){
        ...
        for($i = 0; $i<count($arrayT1);$i++){
            ...
            <p id="PfTimerT1"> Lith
                ...
                <span id="<?=$arrayT1[$i]['node']?>" class="fissuresTimerT1"><?=$arrayT1[$i]['Expiry']?></span>
    ...
    ?>
            <p id="PfTimerT2"> Meso
                ...
                <span id="<?=$arrayT2[$i]['node']?>" class="fissuresTimerT2"><?=$arrayT2[$i]['Expiry']?></span>
            </p>
    <?php
        }
    }
    ...
    if(count($arrayT3) != 0){
        for($i = 0; $i<count($arrayT3);$i++){
            ...
            <p id="PfTimerT3"> Neso
                ...
                <span id="<?=$arrayT3[$i]['node']?>" class="fissuresTimerT3"><?=$arrayT3[$i]['Expiry']?></span>
            </p>
            <?php
        }
    }
    ...
    if(count($arrayT4) != 0){
        for($i = 0; $i<count($arrayT4);$i++){
            ...
            <p id="PfTimerT4"> Axi
                ...
                <span id="<?=$arrayT4[$i]['node']?>" class="fissuresTimerT4"><?=$arrayT4[$i]['Expiry']?></span>
            </p>
            <?php
        }
    }
    ...
    if(count($arrayT5) != 0){
        for($i = 0; $i<count($arrayT5);$i++){
            ...
            <p id="PfTimerT5"> Requiem
                ...
                <span id="<?=$arrayT5[$i]['node']?>" class="fissuresTimerT5"><?=$arrayT5[$i]['Expiry']?></span>
            </p>
